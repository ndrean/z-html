...
//     // print("Tree with attributes and comments:\n", .{});
//     // tree.display();
// }
...
//     const comment_node = HtmlNode{ .comment = " A comment " };
