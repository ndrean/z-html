...
// \\<html xmlns="http://www.w3.org/1999/xhtml"><head><style type="text/css">@font-face {font-family: y; src: url("font.svg#x") format("svg");} body {font: 100px "y";}</style></head><body>Hello</body>\\</html>//["'`-->]]>]</div>
...
// <div id="71"><// style=x:expression(alert(71))>//["'`-->]]>]</div>
...
// <div id="98"><div id=d><div style="font-family:'sans-serif;color:red'">X</div></div>
