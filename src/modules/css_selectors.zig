...
extern "c" fn lxb_selectors_find(selectors: *z.CssSelectors, root: *z.DomNode, list: *z.CssSelectorList, callback: *const fn (
    ...
    ctx: ?*anyopaque,
) callconv(.c) c_int, ctx: ?*anyopaque) c_int;

extern "c" fn lxb_selectors_match_node(selectors: *z.CssSelectors, node: *z.DomNode, list: *z.CssSelectorList, callback: *const fn (*z.DomNode, *z.CssSelectorSpecificity, ?*anyopaque) callconv(.c) c_int, ctx: ?*anyopaque) usize;
...
fn findCallback(node: *z.DomNode, spec: *z.CssSelectorSpecificity, ctx: ?*anyopaque) callconv(.c) c_int {
    _ = spec;
    const context: *FindContext = @ptrCast(@alignCast(ctx.?));
    context.results.append(context.allocator, node) catch return z._STOP;
    return z._CONTINUE;
}
...
fn findFirstNodeCallback(node: *z.DomNode, spec: *z.CssSelectorSpecificity, ctx: ?*anyopaque) callconv(.c) c_int {
    _ = spec;
...
fn findFirstElementCallback(node: *z.DomNode, spec: *z.CssSelectorSpecificity, ctx: ?*anyopaque) callconv(.c) c_int {
    _ = spec;
    ...
    if (z.nodeToElement(node)) |element| {
        ...
        // Large positive number to indicate early stop
        return z._STOP;
        // return 0x7FFFFFFF;
    }
    return z._CONTINUE;
